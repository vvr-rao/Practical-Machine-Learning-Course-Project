...
The goal of the project is to analyze exercide data captured by a third party and build an algorithm to predict how correctly the exercise was performed.
